...
This command will be available in chat with /generate-tasks

## Goal

To guide an AI assistant in creating a detailed, step-by-step task list in Markdown format based on user requirements, feature requests, or existing documentation. The task list should guide a developer through implementation. The developer should be able to implement the tasks in order and after the 2nd parent task is complete be able to interact with the feature locally.
